...
public class StockAdjustmentsController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(AppAction.View, AppResource.StockAdjustments)]
    ...
    [HttpPost]
    [MustHavePermission(AppAction.Create, AppResource.StockAdjustments)]
    ...
    [HttpPut("{voucherNo}")]
    [MustHavePermission(AppAction.Update, AppResource.StockAdjustments)]
    ...
    [MustHavePermission(AppAction.Delete, AppResource.StockAdjustments)]
